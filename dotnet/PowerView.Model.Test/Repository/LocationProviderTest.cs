...
namespace PowerView.Model.Test.Repository
{
  ...
  public class LocationProviderTest
  {
    ...
    public void ConstructurThrows()
    {
      ...
      // Act & Assert
      Assert.That(() => new LocationProvider(null, settingRepository.Object, "Not null or empty", "Not null or empty"), Throws.TypeOf<ArgumentNullException>());
      Assert.That(() => new LocationProvider(new NullLogger<LocationProvider>(), null, "Not null or empty", "Not null or empty"), Throws.TypeOf<ArgumentNullException>());
    }
    ...
    {
      return new LocationProvider(new NullLogger<LocationProvider>(), settingRepository.Object, configuredTimeZoneId, configuredCultureInfo);
    }
