...
namespace PowerView
{
    internal class TestDataGenerator
    {
        ...
        public TestDataGenerator(ILogger<TestDataGenerator> logger, IServiceScope serviceScope)
        {
        ...
        public void Generate()
        {
            ...
            logger.LogInformation("Done generating test data");
        }

        private void GenerateMeterEvents()
        {
            logger.LogInformation("Generating meter events test data..");
            var repo = serviceScope.ServiceProvider.GetRequiredService<IMeterEventRepository>();
        ...
        {
            var profileRepo = serviceScope.ServiceProvider.GetRequiredService<IProfileRepository>();
            ...
            logger.LogInformation("Generating day profile test data..");
            var repo = serviceScope.ServiceProvider.GetRequiredService<ILiveReadingRepository>();
        ...
        private static IDictionary<string, SerieGenerator[]> GetSerieGenerators()
        {
            ...
            var mainActualPowerP23 = new SumSG
            {
                Unit = Unit.Watt,
                Scale = 0,
                ObisCode = OC.ElectrActualPowerP23,
                BackingGenerators = new[] {
