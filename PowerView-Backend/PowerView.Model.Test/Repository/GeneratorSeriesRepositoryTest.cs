  ...
  public class GeneratorSeriesRepositoryTest : DbTestFixtureWithSchema
  {
    ...
    public void GetGeneratorSeries()
    {
      ...
      DbContext.InsertGeneratorSeries(
        new Db.GeneratorSeries { Label = "lbl1", ObisCode = ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH, BaseLabelId = labels[0].Id, BaseObisId = obisCodes[0].Id, CostBreakdownTitle = "CostBreakdown1" },
        new Db.GeneratorSeries { Label = "lbl3", ObisCode = ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH, BaseLabelId = labels[1].Id, BaseObisId = obisCodes[0].Id, CostBreakdownTitle = "CostBreakdown2" });
      ...
      AssertGeneratorSeries(new SeriesName("lbl1", ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH),
        new SeriesName("lbl2", ObisCode.ElectrActiveEnergyKwhIncomeExpenseExclVatH), "CostBreakdown1", generatorSeries.First());
      AssertGeneratorSeries(new SeriesName("lbl3", ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH),
        new SeriesName("lbl4", ObisCode.ElectrActiveEnergyKwhIncomeExpenseExclVatH), "CostBreakdown2", generatorSeries.Last());
    }
    ...
    public void AddGeneratorSeries()
    {
      ...
      DbContext.InsertObisCodes(ObisCode.ElectrActiveEnergyKwhIncomeExpenseExclVatH);
      var generatorSeries = new GeneratorSeries(new SeriesName("lbl1", ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH),
        new SeriesName("lblOther", ObisCode.ElectrActiveEnergyKwhIncomeExpenseExclVatH), "CostBreakdownTitle1");
      var target = CreateTarget();
    ...
    public void DeleteGeneratorSeriesAbsent()
    {
      ...
      DbContext.InsertObisCodes(ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH);
      var target = CreateTarget();

      // Act
      target.DeleteGeneratorSeries(new SeriesName("lbl1", ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH));
    ...
    public void DeleteGeneratorSeries()
    {
      ...
      // Assert
      AssertGeneratorSeriesExists("lbl1", ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH, "lbl2", ObisCode.ElectrActiveEnergyKwhIncomeExpenseExclVatH, "CostBreakdown1", not: true);
      AssertGeneratorSeriesExists("lbl3", ObisCode.ElectrActiveEnergyKwhIncomeExpenseInclVatH, "lbl4", ObisCode.ElectrActiveEnergyKwhIncomeExpenseExclVatH, "CostBreakdown2");
    }
    ...
    public void GetBaseSeries(string obisCode)
    {
      // Arrange
      var labels = DbContext.InsertLabels("lbl1", "lbl2");
      var obis = DbContext.InsertObisCodes(obisCode);
      ...
      Assert.That(items, Is.EquivalentTo(new[] {
        (new SeriesName("lbl1", obisCode), dateTime1),
        (new SeriesName("lbl2", obisCode), dateTime2)
      }));
    }
