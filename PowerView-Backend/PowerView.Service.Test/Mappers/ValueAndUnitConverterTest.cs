...
namespace PowerView.Service.Test.Mappers
{
    ...
    public class VaueAndUnitConverterTest
    {
        ...
        [Test]
        public void ConvertValueDkk()
        {
            // Arrange

            // Act
            var valueString = ValueAndUnitConverter.Convert(1234.56789d, Unit.Dkk);
        ...
        [Test]
        public void ConvertValueEur()
        {
            // Arrange

            // Act
            var valueString = ValueAndUnitConverter.Convert(1234.56789d, Unit.Eur);
        ...
        public void ConvertUnitDkk()
        {
            ...
            // Assert
            Assert.That(unitString, Is.EqualTo("DKK"));
        }

        [Test]
        public void ConvertUnitEur()
        {
            // Arrange
            var unit = Unit.Eur;
            ...
            // Assert
            Assert.That(unitString, Is.EqualTo("EUR"));
        }
