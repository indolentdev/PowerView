...
{
    [TestFixture]
    public class DayAheadPricesDtoTest
    {
        [Test]
        ...
        public void DeserializeInvalidThrowsJsonException(string json, string message)
        {
            ...
            // Act & Assert
            Assert.That(() => JsonSerializer.Deserialize<DayAheadPricesDto>(json), Throws.TypeOf<JsonException>(), message);
        }
        ...
        {
            // Arrange
            var dto = JsonSerializer.Deserialize<DayAheadPricesDto>(json);
