...
CREATE TABLE DayReading (Id INTEGER PRIMARY KEY, Label NVARCHAR(10) NOT NULL, SerialNumber INTEGER NOT NULL, Timestamp DATETIME NOT NULL);
...
CREATE TABLE MonthReading (Id INTEGER PRIMARY KEY, Label NVARCHAR(10) NOT NULL, SerialNumber INTEGER NOT NULL, Timestamp DATETIME NOT NULL);
...
CREATE TABLE LiveReading (Id INTEGER PRIMARY KEY, Label NVARCHAR(10) NOT NULL, SerialNumber INTEGER NOT NULL, Timestamp DATETIME NOT NULL);
...
INSERT INTO LiveReading (Id, Label, SerialNumber, Timestamp) SELECT Id, Label, SerialNumber, Timestamp FROM OldLiveReading;
