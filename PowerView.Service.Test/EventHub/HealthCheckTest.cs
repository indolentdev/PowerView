...
namespace PowerView.Service.Test.EventHub
{
    ...
    public class HealthCheckTest
    {
        ...
        public void SetUp()
        {
            ...
            serviceProvider.Setup(sp => sp.GetService(typeof(IHostApplicationLifetime))).Returns(lifetime.Object);
        }
        ...
        public void DailyCheck()
        {
            ...
            serviceProvider.Verify(sp => sp.GetService(typeof(IHostApplicationLifetime)), Times.Never);
        ...
        [Test]
        public void DailyCheckSignalsStopOnCorruptionError()
        {
            // Arrange
            var dateTime = DateTime.UtcNow;
            var target = CreateTarget();
            ...
            // Assert
            dbCheck.Verify(dc => dc.CheckDatabase());
            serviceProvider.Verify(sp => sp.GetService(typeof(IHostApplicationLifetime)));
            lifetime.Verify(esp => esp.StopApplication());
        }
