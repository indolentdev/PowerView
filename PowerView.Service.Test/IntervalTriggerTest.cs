...
namespace PowerView.Service.Test
{
    ...
    public class IntervalTriggerTest
    {
        ...
        [TestCase("1.00:00:00")]
        [TestCase("01:00:00")]
        public void IsTriggerTimeAndAdvance(string timeSpanString)
        {
            // Arrange
            var locationContext = TimeZoneHelper.GetDenmarkLocationContext();
            var baseDateTime = TimeZoneHelper.GetDenmarkFixedMidnightAsUtc();
            ...
            target.Setup(TimeSpan.FromMinutes(15), timeSpan);
        ...
        [TestCase("1.00:00:00")]
        [TestCase("01:00:00")]
        public void IsTriggerTimeAndAdvanceDoubleInterval(string timeSpanString)
        {
            // Arrange
            var locationContext = TimeZoneHelper.GetDenmarkLocationContext();
            var baseDateTime = TimeZoneHelper.GetDenmarkFixedMidnightAsUtc();
            ...
            dateTime = dateTime.Add(timeSpan * 2);
            Assert.That(target.IsTriggerTime(dateTime), Is.True);
            target.Advance(dateTime);
