...
namespace PowerView.Model
{
  public class SmtpConfig
  {
    ...
    public SmtpConfig(string server, ushort port, string user, string auth)
    {
    ...
    {
      return string.Format(CultureInfo.InvariantCulture, "SmtpConfig [Server:{0}, Port:{1}, User:{2}]", Server, Port, User);
    }
