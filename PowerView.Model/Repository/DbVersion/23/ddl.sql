...
INSERT INTO Label (LabelName, Timestamp) SELECT Value, strftime('%s') FROM Tmp;
...
INSERT INTO Device (DeviceName, Timestamp) SELECT Value, strftime('%s') FROM Tmp;

DROP TABLE Tmp;

CREATE TABLE Obis (Id INTEGER PRIMARY KEY, ObisCode INTEGER NOT NULL UNIQUE);
CREATE TABLE Tmp (Value INTEGER NOT NULL);
INSERT INTO Tmp SELECT DISTINCT ObisCode FROM liveRegister;
INSERT INTO Obis (ObisCode) SELECT Value FROM Tmp;
DROP TABLE Tmp;
...
CREATE TABLE LiveRegister (ReadingId INTEGER NOT NULL, ObisId INTEGER NOT NULL, Value INTEGER NOT NULL, Scale INTEGER NOT NULL, Unit INTEGER NOT NULL, PRIMARY KEY(ReadingId,ObisId), FOREIGN KEY (ReadingId) REFERENCES LiveReading(Id), FOREIGN KEY (ObisId) REFERENCES Obis(Id)) WITHOUT ROWID;
...
INSERT INTO LiveRegister (ReadingId, ObisId, Value, Scale, Unit) SELECT ReadingId, o.Id, Value, Scale, Unit FROM LiveRegisterOld r JOIN Obis o ON r.ObisCode = o.ObisCode;
...
CREATE TABLE DayRegister (ReadingId INTEGER NOT NULL, ObisId INTEGER NOT NULL, Value INTEGER NOT NULL, Scale INTEGER NOT NULL, Unit INTEGER NOT NULL, PRIMARY KEY(ReadingId,ObisId), FOREIGN KEY (ReadingId) REFERENCES DayReading(Id), FOREIGN KEY (ObisId) REFERENCES Obis(Id)) WITHOUT ROWID;
...
CREATE TABLE MonthRegister (ReadingId INTEGER NOT NULL, ObisId INTEGER NOT NULL, Value INTEGER NOT NULL, Scale INTEGER NOT NULL, Unit INTEGER NOT NULL, PRIMARY KEY(ReadingId,ObisId), FOREIGN KEY (ReadingId) REFERENCES MonthReading(Id), FOREIGN KEY (ObisId) REFERENCES Obis(Id)) WITHOUT ROWID;
...
CREATE TABLE YearRegister (ReadingId INTEGER NOT NULL, ObisId INTEGER NOT NULL, Value INTEGER NOT NULL, Scale INTEGER NOT NULL, Unit INTEGER NOT NULL, PRIMARY KEY(ReadingId,ObisId), FOREIGN KEY (ReadingId) REFERENCES YearReading(Id), FOREIGN KEY (ObisId) REFERENCES Obis(Id)) WITHOUT ROWID;