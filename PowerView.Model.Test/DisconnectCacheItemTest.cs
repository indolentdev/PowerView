...
namespace PowerView.Model.Test
{
  ...
  public class DisconnectCacheItemTest
  {
    ...
    {
      var rule = new Mock<IDisconnectRule>();
      rule.Setup(r => r.Name).Returns(new SeriesName("Relay", "0.1.96.3.10.255"));
      rule.Setup(r => r.EvaluationName).Returns(new SeriesName("Meter", ObisCode.ElectrActualPowerP14L1));
