...
namespace PowerView.Model.Test.Repository
{
    ...
    public class ReadingPipeRepositoryTest : DbTestFixtureWithSchema
    {
        ...
        public void PipeLiveReadingsToDayReadingsIncludesRegisters()
        {
            ...
            byte obisCode1 = 1;
            byte obisCode2 = 2;
            DbContext.InsertObisCodes((obisCode1, "1.1.1.1.1.1"), (obisCode2, "2.2.2.2.2.2"));
            var liveRegister1 = new Db.LiveRegister { ObisId = obisCode1, ReadingId = liveReading.Id };
            var liveRegister2 = new Db.LiveRegister { ObisId = obisCode2, ReadingId = liveReading.Id };
            ...
            AssertRegister<Db.DayRegister>(liveRegister1.ObisId, liveRegister1.ReadingId);
            AssertRegister<Db.DayRegister>(liveRegister2.ObisId, liveRegister2.ReadingId);
        }
        ...
        public void PipeDayReadingsToMonthReadingsIncludesRegisters()
        {
            ...
            byte obisCode2 = 2;
            DbContext.InsertObisCodes((obisCode1, "1.1.1.1.1.1"), (obisCode2, "2.2.2.2.2.2"));
            var dayRegister1 = new Db.DayRegister { ObisId = obisCode1, ReadingId = dayReading.Id };
            var dayRegister2 = new Db.DayRegister { ObisId = obisCode2, ReadingId = dayReading.Id };
            ...
            AssertRegister<Db.MonthRegister>(dayRegister1.ObisId, dayRegister1.ReadingId);
            AssertRegister<Db.MonthRegister>(dayRegister2.ObisId, dayRegister2.ReadingId);
        }
        ...
        public void PipeMonthReadingsToYearReadingsIncludesRegisters()
        {
            ...
            byte obisCode2 = 2;
            DbContext.InsertObisCodes((obisCode1, "1.1.1.1.1.1"), (obisCode2, "2.2.2.2.2.2"));
            var monthRegister1 = new Db.MonthRegister { ObisId = obisCode1, ReadingId = monthReading.Id };
            var monthRegister2 = new Db.MonthRegister { ObisId = obisCode2, ReadingId = monthReading.Id };
            ...
            AssertRegister<Db.YearRegister>(monthRegister1.ObisId, monthRegister1.ReadingId);
            AssertRegister<Db.YearRegister>(monthRegister2.ObisId, monthRegister2.ReadingId);
        }
        ...
        private void AssertRegister<TRegister>(int obisId, long readingId)
          where TRegister : class, IDbRegister
        {
            var tableName = typeof(TRegister).Name;
            var sql = "SELECT * FROM {0} WHERE Obisid=@obisId AND ReadingId=@readingId;";
            sql = string.Format(CultureInfo.InvariantCulture, sql, tableName);
            var result = DbContext.QueryTransaction<TRegister>(sql, new { obisId, readingId });
            Assert.That(result.Count, Is.EqualTo(1));
        }
