...
namespace PowerView.Model.Test.Repository
{
  ...
  public class ProfileGraphRepositoryTest : DbTestFixtureWithSchema
  {
    ...
    public void GetProfileGraphs()
    {
      ...
      var profileGraphSerieDb11 = new Db.ProfileGraphSerie { Label = "l1", ObisCode = ObisCode.ActiveEnergyA14, ProfileGraphId=profileGraphDb1.Id };
      var profileGraphSerieDb12 = new Db.ProfileGraphSerie { Label = "l1", ObisCode = ObisCode.ActiveEnergyA23, ProfileGraphId=profileGraphDb1.Id };
      ...
      var profileGraphSerieDb21 = new Db.ProfileGraphSerie { Label = "l2", ObisCode = ObisCode.ActiveEnergyA14, ProfileGraphId=profileGraphDb2.Id };
    ...
    public void GetProfileGraphsPeriodPage()
    {
      ...
      var profileGraphSerieDb31 = new Db.ProfileGraphSerie { Label = "l2", ObisCode = ObisCode.ActiveEnergyA14, ProfileGraphId=profileGraphDb3.Id };
      ...
      var profileGraphSerieDb41 = new Db.ProfileGraphSerie { Label = "l2", ObisCode = ObisCode.ActiveEnergyA14, ProfileGraphId=profileGraphDb4.Id };
    ...
    {
      // Arrange
      var sn1 = new SerieName("label", ObisCode.ActiveEnergyA14Interim);
      var sn2 = new SerieName("label", ObisCode.ActualPowerP14);
    ...
    {
      // Arrange
      var profileGraph1 = new ProfileGraph("day", "pPage1", "pTitle1", "5-minutes", 1, new[] { new SerieName("label1", ObisCode.ActualPowerP14) });
      var profileGraph2 = new ProfileGraph("day", "", "pTitle2", "5-minutes", 2, new[] { new SerieName("label2", ObisCode.ActualPowerP14) });
      var target = CreateTarget();
      target.AddProfileGraph(profileGraph1);
    ...
    {
      // Arrange
      var profileGraph = new ProfileGraph("day", "", "pTitle1", "5-minutes", 1, new[] { new SerieName("label1", ObisCode.ActualPowerP14) });
      var target = CreateTarget();
      target.AddProfileGraph(profileGraph);
