...
@Component({
  selector: 'app-export-cost-breakdown-quarterly',
  templateUrl: './export-cost-breakdown-quarterly.component.html',
  styleUrl: './export-cost-breakdown-quarterly.component.css',
  standalone: false
})
export class ExportCostBreakdownQuarterlyComponent {
    ...
    onExport(exportSpec: ExportTitleSpec) {
      ...
      this.exportService.getCostBreakdownExportQuarterly(exportSpec).subscribe(exportCb => {
