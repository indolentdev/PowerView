...
@Component({
  selector: 'app-export-gauges-quarterly',
  templateUrl: './export-gauges-quarterly.component.html',
  styleUrl: './export-gauges-quarterly.component.css',
  standalone: false
})
export class ExportGaugesQuarterlyComponent implements OnInit {
  ...
  onExport(exportSpec: ExportSpec) {
    this.exportService.getGaugesExportQuarterly(exportSpec).subscribe(exportSeriesSet => {
