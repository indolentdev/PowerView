...
export class HelpSeriesDescriptionsTableComponent implements OnInit {
  ...
  private getObisCodes() {
    let obisCodes = [
      ...
      "1.69.25.67.0.255",//Electricity income/expense amount per kWh within a specific clock hour. Includes VAT or other charges.
      "1.68.25.68.0.255",//Electricity income/expense amount per kWh within a specific quarter of an clock hour. Excludes VAT or other charges.
      "1.69.25.68.0.255",//Electricity income/expense amount per kWh within a specific quarter of an clock hour. Includes VAT or other charges.
