...
export class SettingsCostBreakdownEntryComponent {
  ...
  ngOnInit() {
    this.formGroup = new UntypedFormGroup({
      ...
      startTime: new UntypedFormControl('', [Validators.required, Validators.min(0), Validators.max(22)]),
      endTime: new UntypedFormControl('', [Validators.required, Validators.min(1), Validators.max(23) ]),
