...
import { ProfileDayComponent } from './profile-day.component';

describe('ProfileDayComponent', () => {
  let component: ProfileDayComponent;
  let fixture: ComponentFixture<ProfileDayComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ProfileDayComponent);
